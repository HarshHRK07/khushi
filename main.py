...
# Function to forward message along with bot's response to a specific group
def forward_chat_to_group(message, response):
    # ID of the specific Telegram group to forward messages to
    target_group_id = "-1002020685168"
...
def handle_messages(message):
    ...
    # Forward the message to a specific Telegram group
    response = chat(user_id, user_input)
    forward_chat_to_group(message, response)
